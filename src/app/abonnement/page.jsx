...
const plans = [
  { nom: "Gratuit", prix: 0, desc: "7 jours d'essai", features: ["1 utilisateur", "Tous les modules", "CRM jusqu'a 5 clients", "10 transactions", "Sans carte bancaire"], code: "WOLO_FREE" },
  { nom: "Starter", prix: 5000, desc: "Pour demarrer", features: ["1 utilisateur", "CRM jusqu'a 20 clients", "Finance Tracker", "Taches illimitees", "Support email"], code: "PLN_1cog0is9bljj7i4" },
  { nom: "Business", prix: 15000, desc: "Le plus populaire", features: ["5 utilisateurs", "CRM illimite", "Tous les modules", "Wiki & Alertes", "Support prioritaire"], popular: true, code: "PLN_2yi2j4rlx4xz1bf" },
  { nom: "Pro", prix: 35000, desc: "Pour les equipes", features: ["Utilisateurs illimites", "Tout Business inclus", "Exports de donnees", "Integrations", "Support dedie"], code: "PLN_dtigt5d5a57xjoy" },
];
  ...
  const payer = (plan, method) => {
    ...
    const handler = window.PaystackPop.setup({
      ...
      callback: (response) => {
        ...
        alert(`Abonnement active ! Bienvenue sur WOLO ${plan.nom}`);
        window.location.href = "/";
      },
    ...
    <div style={{ minHeight: "100vh", background: bg, color: text, fontFamily: "Inter, sans-serif", padding: "60px 48px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          <p style={{ fontSize: 16, color: sub }}>7 jours gratuits · Annulation a tout moment · Mobile Money & Carte bancaire</p>
        </div>
