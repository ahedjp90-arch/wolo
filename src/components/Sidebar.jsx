...
export default function Sidebar({ activeNav, setActiveNav }) {
 ...
 return (
   <div style={{ width: collapsed ? 64 : 220, background: "#111128", borderRight: "1px solid #1E1E38", display: "flex", flexDirection: "column", padding: "24px 0", transition: "width 0.25s ease", flexShrink: 0, position: "relative", zIndex: 10, height: "100vh" }}>
     ...
     {/* Utilisateur */}
     <div style={{ padding: "16px 14px 0", borderTop: "1px solid #1E1E38", marginTop: 10, display: "flex", alignItems: "center", gap: 10, overflow: "hidden" }}>
     ...
     <button onClick={() => setCollapsed(!collapsed)} style={{ position: "absolute", top: 24, right: -12, width: 24, height: 24, borderRadius: "50%", background: "#1A1A2E", border: "1px solid #2A2A45", color: "#6B6B8A", fontSize: 10, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
       {collapsed ? "▶" : "◀"}
     </button>
   </div>
 );
